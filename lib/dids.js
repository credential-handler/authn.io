...
bedrock.events.on('bedrock-express.configure.routes', function(app) {
  ...
  app.options('/dids', cors());
  app.options('/dids/:did', cors());
  ...
  const popHeaders = ['retry-after', 'www-authenticate'];

  // registers a new DID and creates a DID document for it
  app.post('/dids/',
    cors({allowedHeaders: popHeaders, exposedHeaders: popHeaders}),
