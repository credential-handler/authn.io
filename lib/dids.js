    ...
    function(req, res, next) {
      ...
      async.auto({
        ...
        checkPermission: ['checkProof', 'getKey', function(callback, results) {
          _hasPermission(req.body, results.getKey, 'writePermission', callback);
        }],
...
function _isAuthorized(doc, keyId, permission, callback) {
  ...
  async.auto({
    ...
    check: ['getKey', function(callback, results) {
      _hasPermission(doc, results.getKey, permission, callback);
    }]
...
function _hasPermission(doc, key, permission, callback) {
