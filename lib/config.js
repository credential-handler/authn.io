...
config.requirejs.bower.packages.push({
  ...
  manifest: {
    name: 'authio',
    moduleType: 'amd',
    main: ['./main.js', './authorization.io.less'],
    dependencies: {
      angular: '',
      // list dependencies to ensure auth.io less file is added last
      'bedrock-angular': '',
...
config.views.vars.style.brand.src = '/images/authorization-io-logo.png';
